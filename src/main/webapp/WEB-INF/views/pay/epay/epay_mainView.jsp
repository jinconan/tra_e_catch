...
function listoption(){
	...
	if(optnum=="작업지시서"){
		$.ajax({
	        method:"POST"
	        ,url:"<%=request.getContextPath()%>/pay/epay/jobInst"
	        ,data:"",
				...
				<table>
					<tr>
						...
						<select class="form-control" id="optionnum" name="p_c_name">
							...
							<option val="1"><a href="<%=request.getContextPath()%>/pay/epay/jobInst">작업지시서</a></option>
							<option val="2">기획서</option>
							<option val="3">계약서</option>
							<option val="4">근로계약서</option>
						</select>
						</td>
						<td>&nbsp;&nbsp;&nbsp;</td>
						<td>사용 용도 : &nbsp;&nbsp;&nbsp;</td>
