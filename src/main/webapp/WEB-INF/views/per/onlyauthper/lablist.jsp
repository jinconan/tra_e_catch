...
<div class="container">
	...
	<form id="f_modalselect" method="post">
		<input type="hidden" id="selectdate" name="hday"> <input type="hidden" id="selectemp_no" name="emp_no" value="<%=emp_no%>">
	</form>
		...
		<div class="modal-dialog" role="document" style="width: 635px">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">근로계약서 상세페이지</h5>
